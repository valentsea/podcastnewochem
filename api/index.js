...
getEpisodesFromRSS().then((episodes) => {
...
app.get('/api/podcast', (req, res) => {
	res.send(require('./podcast.json'))
})

app.listen(port, () => {
	console.log(`The app listening at http://localhost:${port}/episodes`)
